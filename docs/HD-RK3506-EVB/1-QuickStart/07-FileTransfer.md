...
HD-RK3506-EVB支持双路百兆以太口，系统默认eth0采用静态IP 地址配置，eth1采用动态IPv4地址获取。
...
<img src={require('./images/05-filetransfer-01.png').default} alt="304cf4bcbac61d83ed82e250b53a3a66.png" className="doc-image--80" />
...
<img src={require('./images/05-filetransfer-02.png').default} alt="image.png" className="doc-image--80" />

为了更方便使用，可以将adb加入到系统环境变量中。在Windows系统下，搜索环境变量，打开编辑系统环境变量。

<img src={require('./images/05-filetransfer-03.png').default} alt="屏幕截图 2026-07-15 095456.png" className="doc-image--80" />
